...
def extraer_datos_2026():
    ...
    tabla_ind = 'caracterizacion_si_aps_individual_2026'
    if not table_exists(tabla_ind): 
        tabla_ind = 'aps_2026_integrantes'
    ...
    tabla_fam = 'caracterizacion_si_aps_familiar_2026'
    if not table_exists(tabla_fam): 
        tabla_fam = 'aps_2026_familias'
